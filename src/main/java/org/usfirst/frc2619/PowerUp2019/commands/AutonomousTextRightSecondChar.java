 ...
 *
 */
public class AutonomousTextRightSecondChar extends ConditionalCommand {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousTextRightSecondChar() {
      super(new AutonomousTextRightLeft(), new AutonomousTextRightRight());
