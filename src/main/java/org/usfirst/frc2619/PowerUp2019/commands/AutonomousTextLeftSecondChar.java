 ...
 *
 */
public class AutonomousTextLeftSecondChar extends ConditionalCommand {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousTextLeftSecondChar() {
      super(new AutonomousTextLeftLeft(), new AutonomousTextLeftRight());
