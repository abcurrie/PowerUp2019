 ...
 *
 */
public class AutonomousTextFirstChar extends ConditionalCommand {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousTextFirstChar() {
      super(new AutonomousTextLeftSecondChar(), new AutonomousTextRightSecondChar());
